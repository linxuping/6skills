...
require("./upload/moxie.js");
require("./upload/plupload.js");
require("./upload/qiniu.min.js");
let uploadConfig = require("./upload/upload-config.js").default;
									...
									<li className="weui_uploader_file">
										{
											...
											<img src={require("img/loading.gif")} style={{width: "100%", height: "100%"}}/>
											:
